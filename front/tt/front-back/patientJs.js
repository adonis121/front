        ...
        success: function(result) {
            ...
            if (y != null) {
                $.each(y, function(i, item) {
                   ...
                   +'</button></div><div class="modal-body"><form onsubmit="return false;"><div class="chat-messages"><div id="sendFjalet" class="message-box-holder"></div>'
        ...
        success: function(res) {
                   ...
                   if(e == null){
                    ...
                    $.each(y, function(i, item) {
                        ...
                        $("#fjalet").append('<div class="message-sender">Doctor:<div class="message-box message-partner" >'+item.conversationDes+'</div></div>');
